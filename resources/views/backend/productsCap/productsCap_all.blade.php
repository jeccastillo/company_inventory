...
@section('admin')
 ...
 <div class="page-content">
    ...
    <a href="{{route('productCap.add')}}" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;">Add Product</a> <br>  <br>               
                    ...
                    <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        <tbody>
                        	...
                        	@foreach($productsCap as $key => $product)
                        <tr>
                            <td> {{ $key+1}} </td>
                            <td> {{ $product->name }} </td>                             
