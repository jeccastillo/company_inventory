                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('furnitureSupplier.store') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="mobileNo" class="form-control" type="number" id="mobileNum">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="email" class="form-control" type="email" id="emailAdd">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="address" class="form-control" type="text" id="supplierAdd">
                                </div>
                            </div>
                            <!-- end row -->
                            ...
                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Save Supplier">
                        </form>
