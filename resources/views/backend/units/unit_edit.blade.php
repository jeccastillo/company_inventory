                        ...
                        <form method="post" action="{{ route('unit.update') }}" id="myForm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="form-group col-sm-10">
                                    <input name="name" class="form-control" type="text" id="unitName" value="{{$unitToEdit->name}}">
                                </div>
                            </div>
                            <!-- end row -->

                            <input type="submit" class="btn btn-info waves-effect waves-light" value="Save Unit">
                        </form>
                    </div>
                </div>
            </div> <!-- end col -->
